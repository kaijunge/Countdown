...
var A = JSON.parse(JSON.stringify(A_raw))
...
var B = JSON.parse(JSON.stringify(B_raw))
...
var C = JSON.parse(JSON.stringify(C_raw))
...
var D = JSON.parse(JSON.stringify(D_raw))
...
var M = JSON.parse(JSON.stringify(M_raw))
